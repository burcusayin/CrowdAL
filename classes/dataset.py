...
#        test_size = 0.3
#        
#        X_train_indx, X_test_indx, y_train, y_test = train_test_split(range(X.shape[0]), y, stratify=y, random_state=2020, 
#                                                            test_size=test_size, shuffle=True)
#        
#        X_train = X[X_train_indx]
#        X_test = X[X_test_indx]
#        r_train = r[X_train_indx]
#        print('Train size: {}'.format(X_train.shape))
#        print('Test size: {}'.format(X_test.shape))
        
#        v = Vectorizer()
#        v.fit(X_train.astype('U'))
#        X_train = v.transform(X_train.astype('U'))
#        
#        v = Vectorizer()
#        v.fit(X_test.astype('U'))
#        X_test = v.transform(X_test.astype('U'))
